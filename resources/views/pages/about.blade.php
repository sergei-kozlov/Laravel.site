...
@section('content')
    <h3 class="m_2">Morbi lectus risus iaculisvel</h3>
    <ul class="about_grid1 about_box">
        <li class="about_img"><img src="thema/images/a1.jpg" class="img-responsive" alt=""/></li>
        <li class="about_desc">
            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor.</p>
            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor. Morbi lectus risus, iaculis vel, suscipit quis, luctus non, massa. Fusce ac turpis quis ligula lacinia aliquet.</p>
        </li>
    </ul>
    <h3 class="m_2">Curabitur sodales ligula in libero</h3>
    <ul class="about_grid1 about_box">
        <li class="about_img"><img src="thema/images/a2.jpg" class="img-responsive" alt=""/></li>
        <li class="about_desc">
            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor. Morbi lectus risus, iaculis vel, suscipit quis, luctus non, massa. Fusce ac turpis quis ligula lacinia aliquet.</p>
            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor.</p>
        </li>
...
@section('sidebar')
    <h3 class="m_2">Sed accumsan nunc</h3>
    <div class="list styled custom-list">
        <ul>
            <li><i class="fa fa-graduation-cap fa-3x fa-fw pull-left"></i>
                <h5>Nulla quis sem at nibh elementum</h5>
                <p>Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum praesent mauris.</p>
            </li>
            <li><i class="fa fa-users fa-3x fa-fw pull-left"></i>
                <h5>Quis sem at nibh elementum imperdiet</h5>
                <p>Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum praesent mauris.</p>
            </li>
            <li><i class="fa fa-bar-chart fa-3x fa-fw pull-left"></i>
                <h5>Nulla quis sem at nibh elementum</h5>
                <p>Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum praesent mauris.</p>
            </li>
            <li><i class="fa fa-leaf fa-3x fa-fw pull-left"></i>
                <h5>Quis sem at nibh elementum imperdiet</h5>
                <p>Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum praesent mauris.</p>
            </li>
        </ul>
